...
import { createAssistantMessageEventStream, Type } from "@earendil-works/tfa-ai";
import { complete, getModel, getProviders, streamSimple } from "@earendil-works/tfa-ai/compat";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
...
import { decodeCbor, encodeCbor, PROTOCOL_VERSION } from "@earendil-works/tfa-protocol";
