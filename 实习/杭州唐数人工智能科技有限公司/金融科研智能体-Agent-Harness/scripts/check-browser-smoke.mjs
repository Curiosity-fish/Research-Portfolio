...
const outputPath = join(tmpdir(), "tfa-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "tfa-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "tfa-browser-smoke-errors.log");
