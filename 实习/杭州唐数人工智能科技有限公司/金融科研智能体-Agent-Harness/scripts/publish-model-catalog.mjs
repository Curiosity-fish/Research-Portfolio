...
// Bump this only when generated model metadata requires behavior unavailable in older tfa clients.
...
async function main() {
	...
	const temporaryDir = mkdtempSync(join(tmpdir(), "tfa-model-catalog-"));
	try {
