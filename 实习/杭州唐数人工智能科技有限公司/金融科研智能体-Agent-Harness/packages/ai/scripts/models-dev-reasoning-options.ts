...
/**
 * Converts models.dev verified effort values into TFA's selectable thinking levels.
 * Values without a TFA equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
