/**
 * Temporary compatibility entrypoint preserving the old global tfa-ai API
 ...
 *
 * Existing apps switch imports from "@earendil-works/tfa-ai" to
 * "@earendil-works/tfa-ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/tfa-messages.lazy.ts";
...
import { tfaMessagesApi } from "./api/tfa-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@earendil-works/tfa-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@earendil-works/tfa-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@earendil-works/tfa-ai/providers/all" or `Models.getProviders()`. */
