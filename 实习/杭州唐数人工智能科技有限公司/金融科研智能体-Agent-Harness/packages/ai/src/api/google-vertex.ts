...
import type {
	...
	StreamOptions,
	TextContent,
	ThinkingLevel as TfaThinkingLevel,
	ThinkingBudgets,
	ThinkingContent,
	ToolCall,
} from "../types.ts";
...
type ClampedThinkingLevel = Exclude<TfaThinkingLevel, "xhigh" | "max">;
...
function getDisabledThinkingConfig(model: Model<"google-vertex">): ThinkingConfig {
	...
	// thinkingLevel without includeThoughts so hidden thinking remains invisible to tfa.
	const geminiModel = model as unknown as Model<"google-generative-ai">;
