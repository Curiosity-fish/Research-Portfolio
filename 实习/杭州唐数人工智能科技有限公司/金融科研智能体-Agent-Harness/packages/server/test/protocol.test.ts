import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@earendil-works/tfa-ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "@earendil-works/tfa-protocol";
...
describe("tfa-ai protocol bridge", () => {
