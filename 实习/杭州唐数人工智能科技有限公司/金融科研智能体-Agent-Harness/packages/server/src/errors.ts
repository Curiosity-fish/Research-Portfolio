import type { JsonValue, ProtocolErrorCode } from "@earendil-works/tfa-protocol";

export type TfaServerOperationErrorCode = Extract<
	ProtocolErrorCode,
...
export class TfaServerError extends Error {
	readonly code: TfaServerOperationErrorCode;
	readonly details: JsonValue | undefined;

	constructor(code: TfaServerOperationErrorCode, message: string, details?: JsonValue) {
		super(message);
...
export class SessionBusyError extends TfaServerError {
...
export class SessionLockedError extends TfaServerError {
...
export class SessionNotFoundError extends TfaServerError {
...
export class NotImplementedError extends TfaServerError {
	constructor() {
