> tfa can create prompt templates. Ask it to build one for your workflow.
...
TFA loads prompt templates from:

- Global: `~/.tfa/agent/prompts/*.md`
- Project: `.tfa/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `tfa.prompts` entries in `package.json`
