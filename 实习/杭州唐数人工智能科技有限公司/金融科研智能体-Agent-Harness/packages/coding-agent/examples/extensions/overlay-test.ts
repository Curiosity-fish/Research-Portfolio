 ...
 *
 * Usage: tfa --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@earendil-works/tfa-tui";

export default function (tfa: ExtensionAPI) {
	tfa.registerCommand("overlay-test", {
