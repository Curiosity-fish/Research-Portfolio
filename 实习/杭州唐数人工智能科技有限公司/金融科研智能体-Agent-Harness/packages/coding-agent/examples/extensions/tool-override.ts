 ...
 * - Routing tool calls to remote systems (e.g., tfa-ssh-remote)
...
import type { TextContent } from "@earendil-works/tfa-ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@earendil-works/tfa-coding-agent";
