 ...
 * Commands Extension
 *
 * Demonstrates the tfa.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@earendil-works/tfa-coding-agent";

export default function commandsExtension(tfa: ExtensionAPI) {
	tfa.registerCommand("commands", {
