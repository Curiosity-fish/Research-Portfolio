 ...
 * Delegates to tfa-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   tfa -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (tfa: ExtensionAPI) {
	tfa.registerProvider("gitlab-duo", {
