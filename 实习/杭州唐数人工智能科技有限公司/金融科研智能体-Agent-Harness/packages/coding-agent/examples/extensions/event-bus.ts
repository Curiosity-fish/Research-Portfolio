 ...
 *
 * Shows tfa.events for communication between extensions. One extension
...
export default function (tfa: ExtensionAPI) {
	...
	tfa.events.on("my:notification", (data) => {
