...
Play DOOM as an overlay in tfa. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
tfa --extension ./examples/extensions/doom-overlay
```
...
- [tfa-doom](https://github.com/badlogic/pi-doom) for the original tfa integration
