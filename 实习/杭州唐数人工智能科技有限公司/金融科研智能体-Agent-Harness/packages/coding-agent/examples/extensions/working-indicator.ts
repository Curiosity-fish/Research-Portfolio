 ...
 * working indicator shown while tfa is streaming a response.
 *
 * Usage:
 *   tfa --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore tfa's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@earendil-works/tfa-coding-agent";
...
export default function (tfa: ExtensionAPI) {
	...
	tfa.registerCommand("working-indicator", {
