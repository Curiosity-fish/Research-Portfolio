import type {
	...
	TfaClient,
	Unsubscribe,
} from "@earendil-works/tfa-client";
import type {
	ModelMetadata,
	ModelRef,
	ServerEvent,
...
export class RemoteSession {
	...
	private constructor(client: TfaClient, options: RemoteSessionOptions = {}) {
		this.#client = client;
	...
	static async open(client: TfaClient, sessionId: string, options: RemoteSessionOptions = {}): Promise<RemoteSession> {
