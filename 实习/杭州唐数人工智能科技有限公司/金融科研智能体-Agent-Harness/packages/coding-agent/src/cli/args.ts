...
import type { ThinkingLevel } from "@earendil-works/tfa-agent-core";
...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|tfa]   Update tfa, extensions, or model catalogs
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as TFA_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  TFA_PACKAGE_DIR                   - Override package directory (for Nix/Guix store paths)
  TFA_OFFLINE                       - Disable startup network operations when set to 1/true/yes
  TFA_TELEMETRY                     - Override install telemetry when set to 1/true/yes or 0/false/no
  TFA_SHARE_VIEWER_URL              - Base URL for /share command (default: https://pi.dev/session/)
