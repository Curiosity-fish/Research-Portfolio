import { ProcessTerminal, setKeybindings, type TUI, TuiMainScreen } from "@earendil-works/tfa-tui";
...
const OFFICIAL_PACKAGE_NAME = "@earendil-works/tfa-coding-agent";
const OFFICIAL_APP_NAME = "tfa";
const OFFICIAL_CONFIG_DIR_NAME = ".tfa";
 ...
 * - this is the official TFA distribution (not a fork/rebrand)
 * - experimental features are enabled (TFA_EXPERIMENTAL=1)
