...
export function getPackageDir(): string {
	...
	const envDir = process.env.TFA_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json tfaConfig)
// =============================================================================
...
const tfaConfigName: string | undefined = pkg.tfaConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@earendil-works/tfa-coding-agent";
export const APP_NAME: string = tfaConfigName || "tfa";
export const APP_TITLE: string = tfaConfigName ? APP_NAME : "TFA";
export const CONFIG_DIR_NAME: string = pkg.tfaConfig?.configDir || ".tfa";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., TFA_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.TFA_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.tfa/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.tfa/agent/) */
