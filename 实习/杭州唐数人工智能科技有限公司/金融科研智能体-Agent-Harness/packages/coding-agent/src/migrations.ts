...
/**
 * Migrate sessions from ~/.tfa/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.tfa/agent/ instead of
 * ~/.tfa/agent/sessions/<encoded-cwd>/. This migration moves them
 ...
 * Note: tools/ may contain fd/rg binaries extracted by tfa, so only warn if it has other files.
 */
