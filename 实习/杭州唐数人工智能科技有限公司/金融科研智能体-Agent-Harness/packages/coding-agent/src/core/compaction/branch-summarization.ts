...
import type { AgentMessage, StreamFn } from "@earendil-works/tfa-agent-core";
import type { RetryCallbacks, RetryPolicy } from "@earendil-works/tfa-ai";
import { contentText } from "@earendil-works/tfa-ai";
import type { Model, SimpleStreamOptions, Usage } from "@earendil-works/tfa-ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from tfa-generated summaries (fromHook !== true), not extension-generated ones
