...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@earendil-works/tfa-agent-core";
import { contentText, type RetryCallbacks, type RetryPolicy, retryAssistantCall, uuidv7 } from "@earendil-works/tfa-ai";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@earendil-works/tfa-ai/compat";
import { completeSimple } from "@earendil-works/tfa-ai/compat";
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if tfa-generated)
