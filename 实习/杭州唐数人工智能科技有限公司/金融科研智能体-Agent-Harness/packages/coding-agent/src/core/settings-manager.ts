...
import type { Transport } from "@earendil-works/tfa-ai";
import type { TuiMode as RendererTuiMode, ScrollViewScrollbar } from "@earendil-works/tfa-tui";
...
export interface Settings {
	...
	httpProxy?: string; // Proxy URL applied as HTTP_PROXY and HTTPS_PROXY for TFA-managed HTTP clients
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.TFA_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.TFA_HARDWARE_CURSOR === "1";
	}
