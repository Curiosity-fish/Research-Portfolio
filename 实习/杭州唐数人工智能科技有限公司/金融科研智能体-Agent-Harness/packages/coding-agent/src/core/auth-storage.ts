 ...
 * Provider auth orchestration belongs to ModelRuntime and tfa-ai Models.
 */

import type { AuthOperationOptions, Credential, CredentialInfo, CredentialStore } from "@earendil-works/tfa-ai";
