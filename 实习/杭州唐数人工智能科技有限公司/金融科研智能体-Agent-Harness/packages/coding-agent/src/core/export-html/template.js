    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="tfa-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="tfa-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'tfa-share:v1:sidebar-width';
