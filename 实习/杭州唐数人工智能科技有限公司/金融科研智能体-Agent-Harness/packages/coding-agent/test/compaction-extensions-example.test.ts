...
vi.mock("@earendil-works/tfa-coding-agent", () => ({
...
describe("Documentation example", () => {
	it("custom compaction example should type-check correctly", () => {
		...
		const exampleExtension = (tfa: ExtensionAPI) => {
			tfa.on("session_before_compact", async (event: SessionBeforeCompactEvent, ctx) => {
	...
	it("compact event should have correct fields", () => {
		const checkCompactEvent = (tfa: ExtensionAPI) => {
			tfa.on("session_compact", async (event: SessionCompactEvent) => {
