...
import type { AssistantMessage, Model } from "@earendil-works/tfa-ai";
...
vi.mock("@earendil-works/tfa-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@earendil-works/tfa-ai/compat")>();
	return {
		...actual,
