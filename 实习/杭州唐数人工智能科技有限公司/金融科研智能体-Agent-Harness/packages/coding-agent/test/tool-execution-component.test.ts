...
import { Text, type TUI } from "@earendil-works/tfa-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".tfa", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .tfa/AGENTS.md",
			hidden: "Hidden resource instructions",
			absent: undefined,
		},
		{
			title: "AGENTS.override.md",
			path: join(process.cwd(), ".tfa", "AGENTS.override.md"),
			content: "Hidden override instructions",
			compact: "read resource .tfa/AGENTS.override.md",
	...
	for (const scenario of [
		...
		{ title: "TFA documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
