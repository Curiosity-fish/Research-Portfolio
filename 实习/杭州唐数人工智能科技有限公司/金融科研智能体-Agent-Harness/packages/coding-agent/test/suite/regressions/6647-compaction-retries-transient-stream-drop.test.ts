import type { StreamFn } from "@earendil-works/tfa-agent-core";
import { type AssistantMessage, createAssistantMessageEventStream, fauxAssistantMessage } from "@earendil-works/tfa-ai";
