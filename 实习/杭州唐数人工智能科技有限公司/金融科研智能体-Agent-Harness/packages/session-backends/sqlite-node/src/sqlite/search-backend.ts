import type { SessionSearch, SessionSearchHit, SessionSearchOptions } from "@earendil-works/tfa-agent-core";
import { getFileSystemResultOrThrow } from "@earendil-works/tfa-agent-core";
