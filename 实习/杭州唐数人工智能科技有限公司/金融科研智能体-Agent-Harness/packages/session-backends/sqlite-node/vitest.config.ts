...
export default defineConfig({
	...
	resolve: {
		alias: [
			{ find: /^@earendil-works\/tfa-telemetry$/, replacement: telemetryIndex },
			{ find: /^@earendil-works\/tfa-agent-core\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^@earendil-works\/tfa-agent-core\/node$/, replacement: agentNode },
			{ find: /^@earendil-works\/tfa-agent-core$/, replacement: agentIndex },
			{ find: /^@earendil-works\/tfa-ai$/, replacement: aiIndex },
		],
	},
});
