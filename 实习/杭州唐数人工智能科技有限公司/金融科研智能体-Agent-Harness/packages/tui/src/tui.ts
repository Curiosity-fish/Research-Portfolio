...
export const VIEWPORT_TUI = Symbol.for("@earendil-works/tfa-tui/viewport");
...
export abstract class TuiBase extends Container implements TUI {
	...
	private showHardwareCursor = process.env.TFA_HARDWARE_CURSOR === "1";
	private clearOnShrink = process.env.TFA_CLEAR_ON_SHRINK === "1";
	...
	constructor(terminal: Terminal, showHardwareCursor?: boolean, logDirectory?: string) {
		...
		this.logDirectory = logDirectory ?? process.env.TFA_CODING_AGENT_DIR ?? path.join(os.homedir(), ".tfa", "agent");
