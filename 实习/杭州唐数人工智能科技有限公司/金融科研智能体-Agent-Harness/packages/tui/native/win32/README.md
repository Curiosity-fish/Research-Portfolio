...
For non-Windows cross-builds, or for custom Windows toolchains, set `TFA_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
TFA_TUI_WIN32_TOOLCHAIN=mingw \
