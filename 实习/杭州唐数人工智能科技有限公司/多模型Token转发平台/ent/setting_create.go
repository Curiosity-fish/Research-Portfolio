...
func (_c *SettingCreate) SetIsPublic(v bool) *SettingCreate {
	_c.mutation.SetIsPublic(v)
	return _c
}

// SetNillableIsPublic sets the "is_public" field if the given value is not nil.
func (_c *SettingCreate) SetNillableIsPublic(v *bool) *SettingCreate {
	if v != nil {
		_c.SetIsPublic(*v)
	}
	return _c
...
func (_c *SettingCreate) check() error {
	...
	if _, ok := _c.mutation.IsPublic(); !ok {
		return &ValidationError{Name: "is_public", err: errors.New(`ent: missing required field "Setting.is_public"`)}
	}
	return nil
}
