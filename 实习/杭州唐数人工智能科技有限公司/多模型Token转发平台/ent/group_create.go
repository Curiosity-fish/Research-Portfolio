...
func (_c *GroupCreate) SetCode(v string) *GroupCreate {
...
func (_c *GroupCreate) AddGroupPlatformIDs(ids ...uuid.UUID) *GroupCreate {
	_c.mutation.AddGroupPlatformIDs(ids...)
	return _c
}

// AddGroupPlatforms adds the "group_platforms" edges to the GroupPlatform entity.
func (_c *GroupCreate) AddGroupPlatforms(v ...*GroupPlatform) *GroupCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
