...
func (_q *AccountQuery) QueryPlatform() *PlatformQuery {
...
func (_q *AccountQuery) QueryCallLogs() *CallLogQuery {
...
func (_q *AccountQuery) WithPlatform(opts ...func(*PlatformQuery)) *AccountQuery {
	query := (&PlatformClient{config: _q.config}).Query()
...
func (_q *AccountQuery) WithCallLogs(opts ...func(*CallLogQuery)) *AccountQuery {
	query := (&CallLogClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := _q.withPlatform; query != nil {
		if err := _q.loadPlatform(ctx, query, nodes, nil,
			func(n *Account, e *Platform) { n.Edges.Platform = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCallLogs; query != nil {
		if err := _q.loadCallLogs(ctx, query, nodes,
			func(n *Account) { n.Edges.CallLogs = []*CallLog{} },
			func(n *Account, e *CallLog) { n.Edges.CallLogs = append(n.Edges.CallLogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AccountQuery) loadPlatform(ctx context.Context, query *PlatformQuery, nodes []*Account, init func(*Account), assign func(*Account, *Platform)) error {
...
func (_q *AccountQuery) loadCallLogs(ctx context.Context, query *CallLogQuery, nodes []*Account, init func(*Account), assign func(*Account, *CallLog)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(calllog.FieldAccountID)
	}
	query.Where(predicate.CallLog(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(account.CallLogsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
