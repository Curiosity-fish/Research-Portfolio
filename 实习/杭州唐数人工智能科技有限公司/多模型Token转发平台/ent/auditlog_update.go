...
func (_u *AuditLogUpdate) SetActorType(v auditlog.ActorType) *AuditLogUpdate {
	_u.mutation.SetActorType(v)
	return _u
}

// SetNillableActorType sets the "actor_type" field if the given value is not nil.
func (_u *AuditLogUpdate) SetNillableActorType(v *auditlog.ActorType) *AuditLogUpdate {
	if v != nil {
		_u.SetActorType(*v)
	}
	return _u
...
func (_u *AuditLogUpdate) SetTargetID(v uuid.UUID) *AuditLogUpdate {
	_u.mutation.SetTargetID(v)
	return _u
}

// SetNillableTargetID sets the "target_id" field if the given value is not nil.
func (_u *AuditLogUpdate) SetNillableTargetID(v *uuid.UUID) *AuditLogUpdate {
	if v != nil {
		_u.SetTargetID(*v)
	}
	return _u
...
func (_u *AuditLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.TargetID(); ok {
		_spec.SetField(auditlog.FieldTargetID, field.TypeUUID, value)
	}
	if _u.mutation.TargetIDCleared() {
		_spec.ClearField(auditlog.FieldTargetID, field.TypeUUID)
	}
...
// SetActorType sets the "actor_type" field.
func (_u *AuditLogUpdateOne) SetActorType(v auditlog.ActorType) *AuditLogUpdateOne {
	_u.mutation.SetActorType(v)
	return _u
}

// SetNillableActorType sets the "actor_type" field if the given value is not nil.
func (_u *AuditLogUpdateOne) SetNillableActorType(v *auditlog.ActorType) *AuditLogUpdateOne {
	if v != nil {
		_u.SetActorType(*v)
	}
	return _u
...
// SetTargetID sets the "target_id" field.
func (_u *AuditLogUpdateOne) SetTargetID(v uuid.UUID) *AuditLogUpdateOne {
	_u.mutation.SetTargetID(v)
	return _u
}

// SetNillableTargetID sets the "target_id" field if the given value is not nil.
func (_u *AuditLogUpdateOne) SetNillableTargetID(v *uuid.UUID) *AuditLogUpdateOne {
	if v != nil {
		_u.SetTargetID(*v)
	}
	return _u
