...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			alertrecord.Table:      alertrecord.ValidColumn,
			alertrule.Table:        alertrule.ValidColumn,
			auditlog.Table:         auditlog.ValidColumn,
			balancerecord.Table:    balancerecord.ValidColumn,
			calllog.Table:          calllog.ValidColumn,
			department.Table:       department.ValidColumn,
			group.Table:            group.ValidColumn,
			groupplatform.Table:    groupplatform.ValidColumn,
			guidesection.Table:     guidesection.ValidColumn,
			notification.Table:     notification.ValidColumn,
			notificationread.Table: notificationread.ValidColumn,
			platform.Table:         platform.ValidColumn,
			quotarecord.Table:      quotarecord.ValidColumn,
			quotarequest.Table:     quotarequest.ValidColumn,
